namespace SpaceEngineers.Core.Basics
{
    ...
    public static class FileSystemExtensions
    {
        ...
        {
            inner = source.EnumerateDirectories()
        ...
        public static bool TryGetFile(this DirectoryInfo directory,
                                      string fileNameWithoutExtension,
                                      string? extension,
                                      out FileInfo? info)
        {
            info = directory.EnumerateFiles()
        ...
        public static FileInfo GetFile(this DirectoryInfo directory, string fileNameWithoutExtension, string? extension = null)
        {
        ...
        private static string Amb(IEnumerable<FileSystemInfo> source) =>
            string.Join(Environment.NewLine, source.Select(info => info.FullName));
    }
}