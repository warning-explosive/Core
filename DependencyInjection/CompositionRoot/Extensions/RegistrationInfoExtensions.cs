namespace SpaceEngineers.Core.CompositionRoot.Extensions
{
    ...
    {
        public static ConstructorInfo GetWiringConstructor(this IConstructorResolutionBehavior constructorResolutionBehavior, Type type)
        {
        ...
        internal static Func<(Type Service, Type Implementation), ServiceRegistrationInfo> AutoRegisteredService()
        {
            return info =>
            {
