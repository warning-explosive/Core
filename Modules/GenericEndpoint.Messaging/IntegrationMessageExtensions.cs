namespace SpaceEngineers.Core.GenericEndpoint.Messaging
{
    ...
    public static class IntegrationMessageExtensions
    {
        ...
        {
            message.Headers[IntegrationMessageHeader.ActualDeliveryDate] = actualDeliveryDate;
        }
        ...
        {
            message.Headers[IntegrationMessageHeader.DeferredUntil] = DateTime.Now + dueTime;
        }
        ...
        {
            return message.Headers.ContainsKey(IntegrationMessageHeader.DeferredUntil);
        }
        ...
        {
            var actualCounter = message.ReadHeader<int>(IntegrationMessageHeader.RetryCounter);

            message.Headers[IntegrationMessageHeader.RetryCounter] = actualCounter + 1;
        }
        ...
        public static void MarkAsReplied(this IntegrationMessage message)
        {
            ...
            message.Headers[IntegrationMessageHeader.DidHandlerReplyToTheQuery] = true;
        }
        ...
        {
            return message.Headers.TryGetValue(IntegrationMessageHeader.DidHandlerReplyToTheQuery, out var value)
