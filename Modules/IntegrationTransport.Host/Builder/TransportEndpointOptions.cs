namespace SpaceEngineers.Core.IntegrationTransport.Host.Builder
{
    ...
    public class TransportEndpointOptions
    {
        ...
        internal TransportEndpointOptions(DependencyContainerOptions containerOptions, params Assembly[] aboveAssemblies)
        {
        ...
        {
            return new TransportEndpointOptions(containerOptions, AboveAssemblies.ToArray());
        }
    }
}