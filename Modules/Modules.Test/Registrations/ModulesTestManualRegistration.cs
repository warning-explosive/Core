    ...
    internal class ModulesTestManualRegistration : IManualRegistration
    {
        ...
        public static IDependencyContainer Container(ModulesTestFixture fixture)
        {
            ...
            var assemblies = new[]
            {
                ...
                AssembliesExtensions.FindRequiredAssembly(AssembliesExtensions.BuildName(nameof(SpaceEngineers), nameof(Core), nameof(Core.InMemoryIntegrationTransport), nameof(Core.InMemoryIntegrationTransport.Endpoint))),
                ...
                AssembliesExtensions.FindRequiredAssembly(AssembliesExtensions.BuildName(nameof(SpaceEngineers), nameof(Core), nameof(Core.SettingsManager))),
