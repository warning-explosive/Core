namespace SpaceEngineers.Core.DataAccess.Orm.Sql.Translation
{
    ...
    internal class ConcatJsonObjectsLinqExpressionVisitor : ILinqExpressionVisitor,
                                                            ICollectionResolvable<ILinqExpressionVisitor>
    {
            ...
            Expression expression)
        {
            ...
            if (method == LinqMethods.ConcatJsonObjects())
            {
                ...
                var binaryExpression = new Expressions.BinaryExpression(typeof(void), BinaryOperator.ConcatJsonObjects, left, right);
