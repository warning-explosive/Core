...
public class TypeExtensionsTest : BasicsTestBase
{
    ...
    [InlineData(typeof(AsyncManualResetEvent))]
    [InlineData(typeof(PriorityQueue<,>))]
    [InlineData(typeof(PriorityQueue<string, string>))]
    [InlineData(typeof(PriorityQueue<ICollection<string>, string>))]
    [InlineData(typeof(PriorityQueue<Dictionary<string, ICollection<string>>, string>))]
    [InlineData(typeof(PriorityQueue<Dictionary<string, string[]>, string>))]
